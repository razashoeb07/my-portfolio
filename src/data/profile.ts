  ...
  skills: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Cross-Validation", level: 70 }
      ]
    },
    {
      category: "Statistics",
      items: [
        { name: "Hypothesis Testin", level: 75 },
        { name: "ANOVA", level: 75 },
        { name: "Regression Analysis", level: 70 },
        { name: "Probability Distributions", level: 70 },
      ]
    }
  ],
...
experience: [
  {
    ...
    responsibilities: [
      "Worked as a Python Backend Developer on a government ERP implementation.",
      "Developed backend business logic using Python and Frappe Framework.",
      "Customized ERPNext modules by creating DocTypes, Controllers, and Scripts.",
      "Implemented server-side scripts, validations, and role-based access control."
    ]
  }
],
